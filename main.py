...
class MemorizeApp(App):
    ...
    def build(self):
        ...
        self.settings = SettingsJsonStore(JSON_STORE_NAME)
    ...
    def start_game(self):
        ...
        Erzeugt Screens (Memorize, Remember, Result) mit notwendigen Parametern fuer Settings, Player bzw. GameConfig
        """
